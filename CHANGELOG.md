...
* Update dependency @balena/lint to ^9.1.3 [balena-renovate[bot]]
...
* Update dependency @types/lodash to ^4.17.13 [balena-renovate[bot]]
...
* patch: Correct Dockerfile syntax [Anton Belodedenko]
...
* Optimize the API request to fetch only the uuid & of only the accessible devices [Thodoris Greasidis]
